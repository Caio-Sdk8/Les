...
- Crie um projeto react com create-vite: `npm init --yes vite@latest projetoles.client -- --template=react  --no-rolldown --no-immediate`.
...
- Criar o arquivo de projeto (`projetoles.client.esproj`).
